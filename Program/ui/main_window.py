...
# Add parent dirs to path so core is importable
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..'))
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..', '..'))
from Program.core import compare, SpectralDensities, MemoryKernel
...
class PlotCanvas(FigureCanvas):
    ...
    def plot_result(self, result):
        ...
        self.fig.suptitle(
            ...
            "Hope 'n Mind Research — DOI: 10.5281/zenodo.19486927",
...
class MainWindow(QMainWindow):
    ...
    def _build_statusbar(self):
        self.statusBar().showMessage(
            f"Hope 'n Mind Research — MaxEnt-Kernel v1.0.0 — Output: {self.output_dir}"
        )
...
def main():
    ...
    app.setOrganizationName("Hope 'n Mind Research")
    app.setStyle("Fusion")
