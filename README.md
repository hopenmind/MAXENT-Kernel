...
<img src="brand/banner.svg" width="840" alt="BoltZ-Kernel - Non-Markovian Dynamics Solver"/>

<img src="brand/orn-spark.svg" width="22" height="22" alt=""/>
...
<div align="center"><img src="brand/sep-wave.svg" width="100%" alt=""></div>
...
For a self-contained Windows executable without Python, see [releases](https://github.com/hopenmind/MaxEnt-Kernel/releases).
...
@software{desvaux_boltz_kernel_2026,
  ...
  url          = {https://github.com/hopenmind/MaxEnt-Kernel},
}
```
...
<img src="brand/sep-wave.svg" width="100%" height="24" alt="">

<p align="center">[License](./LICENSE)</p>

<p align="center"><sub>Dual-licensed: Apache-2.0 for academic / non-commercial use; proprietary for commercial use.</sub></p>

<br>

<p align="center"><sub>BoltZ-Kernel is published by <b>Hope 'n Mind SASU</b></sub></p>
<p align="center"><sub>SIREN 938 261 310 &middot; RCS Brest &middot; contact@hopenmind.com &middot; hopenmind.com</sub></p>


<p align="center"><em>Built on the Maximum Entropy principle, because nature's memory deserves the least-biased representation.</em></p>
